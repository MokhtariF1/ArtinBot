...
**توجه**: لطفا تا قبل از حداکثر ۱۰ دقیقه بعد از پرداخت وارد ربات شوید و دکمه زیر "پرداخت انجام شد" رو بزنید در‌ غیر این صورت پرداخت تایید نمیشود و پول به حساب شما باز می‌گردد """,
    ...
    "down_force": "دون فرس",
    "start_reaction": "استارت ریکشن",
    "grand_time": "زمان مسابقات",
    ...
    "score_data": "{coin} سکه از حساب شما برای دریافت دیتا کم شد!",
    "level_one": "برنزی",
    "level_two": "نقره ای",
    "level_three": "طلایی",
...
otherwise the payment will not be confirmed and the money will be returned to your account.""",
    ...
    "score_data": "{coin} coins were deducted from your account to receive data!",
    "level_one": "Bronze",
    "level_two": "Silver",
    "level_three": "Golden",
